...
class MediaClient(bce_base_client.BceBaseClient):
    ...
    @required(pipeline_name=(str, str))
    def list_jobs(self,
                  pipeline_name,
                  job_status=None,
                  begin=None,
    ...
    @required(pipeline_name=(str, str), source=dict, target=dict)
    ...
    @required(bucket=(str, str), key=(str, str))
    ...
    @required(preset_name=(str, str), container=(str, str))
    def create_preset(
            self,
            preset_name,
            container,
    ...
    @required(pipeline_name=(str, str), source=dict)
