...
class BmrClient(bce_base_client.BceBaseClient):
    ...
    @required(cluster_id=(str, str), steps=list)
    ...
    @required(cluster_id=(str, str), step_id=(str, str))
    ...
    @required(cluster_id=(str, str), instance_group_id=(str, str))
